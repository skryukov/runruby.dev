...
export const InfoTab = () => {
  return (
    <div className={cs.about}>
      <p>
        <strong>RunRuby.dev</strong> brings Ruby programming into your browser, streamlining the process of writing and
        running Ruby
        code. Here's what sets it apart:
      </p>
      <ul>
        <li>
          <strong>Simple Editing</strong>: Easily create, rename, and manage text files and directories directly in your
          browser.
        </li>
        <li>
        ...
        <li>
          ...
          the <code>Faraday::Adapter::JS</code> adapter to make web requests from Ruby.wasm.
        </li>
        <li>
